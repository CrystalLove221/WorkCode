...
public class Node<E>
{
    ...
    public Node<E> join(Node<E> newNext)
    {
        ...
        if (newNext.previous() != null) {
            throw new IllegalStateException("Desired node is already "
                    + "joined to a node.");
        }
        
        if (this.next != null) {
            throw new IllegalStateException("The node you want to"
                    + "join is already joined.");
        }
