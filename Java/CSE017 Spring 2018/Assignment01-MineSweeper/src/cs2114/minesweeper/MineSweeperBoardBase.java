    ...
    public String toString()
    {
        ...
        for (int y = 0; y < height(); y++)
        {
            ...
            for (int x = 0; x < width(); x++)
            {
                switch (getCell(x, y))
                {
                    case COVERED_CELL:   buffer.append('O'); 
                    break;
                    
                    case FLAG:           buffer.append('F'); 
                    break;
                    
                    case FLAGGED_MINE:   buffer.append('M'); 
                    break;
                    
                    case MINE:           buffer.append('+'); 
                    break;
                    
                    case UNCOVERED_MINE: buffer.append('*'); 
                    break;
                    
                    case ADJACENT_TO_0:  buffer.append(' ');
                    break;
